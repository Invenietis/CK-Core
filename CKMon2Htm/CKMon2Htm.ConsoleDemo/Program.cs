...
namespace CKMon2Htm.ConsoleDemo
{
    class Program
    {
        static void Main( string[] args )
        {
            PrepareDefaultGrandOutput(); // This one writes into ./CKMon2Htm/.
            ...
            if( args.Length >= 1 )
            {
                using( MultiLogReader r = new MultiLogReader() )
                {
                    ...
                    string indexHtmlPath = CKMon2Htm.CreateFromActivityMap( r.GetActivityMap(), m, htmlDirectoryPath );
            ...
            else
            {
                ...
                string indexHtmlPath = CKMon2Htm.CreateFromLogDirectory( directoryPath, m, true );
...
<GrandOutputConfiguration AppDomainDefaultFilter=""Release"" >
    <Channel>
        <Add Type=""BinaryFile"" Name=""GlobalCatch"" Path=""./CKMon2Htm/"" />
    </Channel>
