...
namespace CodeCakeBuilder.CakeTools.Mage
{
    /// <summary>
    /// The SignTool SIGN assembly runner.
    /// </summary>
    public sealed class MageRunner : Tool<MageSettings>
    {
        private readonly IFileSystem _fileSystem;
        private readonly ICakeEnvironment _environment;

        /// <summary>
        /// Initializes a new instance of the <see cref="MageRunner"/> class.
        /// </summary>
        ...
        public void Run( FilePath assemblyPath, MageSettings settings )
        {
        ...
        private ProcessArgumentBuilder GetArguments( FilePath assemblyPath, MageSettings settings )
        {
