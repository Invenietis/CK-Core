...
namespace CK.Core
{
    ...
    /// with <see cref="IWritableCollection{T}"/>. This is a "dangerous" class since to keep the correct ordering, <see cref="CheckPosition(int)"/> 
    ...
    public class CKSortedArrayList<T> : IList<T>, IReadOnlyList<T>, IWritableCollection<T>
    {
