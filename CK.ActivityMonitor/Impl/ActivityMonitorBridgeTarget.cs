#region LGPL License
/*----------------------------------------------------------------------------
* This file (CK.Core\ActivityMonitor\Impl\ActivityMonitorBridgeTarget.cs) is part of CiviKey. 
*  
...
namespace CK.Core
{
    ...
    public sealed class ActivityMonitorBridgeTarget : MarshalByRefObject, ISponsor
    {
        ...
        public ActivityMonitorBridgeTarget( IActivityMonitorImpl targetMonitor, bool honorMonitorFilter = true )
        {
            ...
            _callbacks = _crossAppDomainBriddges = Array.Empty<IActivityMonitorBridgeCallback>();
        }
        ...
        /// whenever the monitors' ActualFilter changed (in such cases, we are bound to the activity: the reentrancy and concurrency 
