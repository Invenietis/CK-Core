#region LGPL License
/*----------------------------------------------------------------------------
* This file (CK.Context\Model\Context\Events\CurrentKeyboardChangedEventArgs.cs) is part of CiviKey. 
*  
...
namespace CK.Keyboard.Model
{
    ...
    /// </summary>
    public class CurrentKeyboardChangedEventArgs : KeyboardContextEventArgs
    {
        /// <summary>
        /// Previously active keyboard of the <see cref="IContext"/>.
        /// </summary>
        public IKeyboard Previous { get; private set; }

        /// <summary>
        /// Current <see cref="IContext"/>'s keyboard.
        /// </summary>
        public IKeyboard Current { get { return Context.CurrentKeyboard; } }
