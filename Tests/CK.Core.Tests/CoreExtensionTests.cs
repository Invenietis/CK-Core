...
namespace Core
{
    ...
    public class CoreExtensionTest
    {
        ...
        {
            Assert.That( Util.BitCount( 0 ) == 0 );
            Assert.That( Util.BitCount( 4 ) == 1 );
            Assert.That( Util.BitCount( 32 ) == 1 );
            Assert.That( Util.BitCount( 128 ) == 1 );
            Assert.That( Util.BitCount( 1 ) == 1 );
            Assert.That( Util.BitCount( 1 | 2 ) == 2 );
            Assert.That( Util.BitCount( 1 | 2 | 4 ) == 3 );
            Assert.That( Util.BitCount( 1 | 2 | 64 ) == 3 );
            Assert.That( Util.BitCount( 1 | 2 | 128 ) == 3 );
            Assert.That( Util.BitCount( 1 | 2 | 32 | 128 ) == 4 );
            Assert.That( Util.BitCount( 1 | 2 | 32 | 64 | 128 ) == 5 );
            Assert.That( Util.BitCount( 1 | 2 | 4 | 8 | 16 | 32 | 64 | 128 ) == 8 );
        }
    }
}
