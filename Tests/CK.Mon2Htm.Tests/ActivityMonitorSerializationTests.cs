#region LGPL License
/*----------------------------------------------------------------------------
* This file (Tests\CK.Mon2Htm.Tests\ActivityMonitorSerializationTests.cs) is part of CiviKey. 
*  
...
<GrandOutputConfiguration AppDomainDefaultFilter=""Release"" >
    <Channel>
        ...
        public static string[] GetCriticalErrorsDumpPaths()
        {
            Assert.That( SystemActivityMonitor.SubDirectoryName, Is.EqualTo( "CriticalErrors/" ) );
