#region LGPL License
/*----------------------------------------------------------------------------
* This file (CK.Core\Impl\Collections\EnumerableConverter.cs) is part of CiviKey. 
*  
...
namespace CK.Core
{
    ...
    public class EnumerableConverter<TOuter, TInner> : Wrapper<IEnumerable<TInner>>, IEnumerable<TOuter>
    {
        ...
        /// <summary>
        /// Gets the converter associated to this <see cref="EnumerableConverter{TOuter,TInner}"/>.
        /// </summary>
