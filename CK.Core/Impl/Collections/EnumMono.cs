#region LGPL License
/*----------------------------------------------------------------------------
* This file (CK.Core\Impl\Collections\EnumMono.cs) is part of CiviKey. 
*  
...
namespace CK.Core
{
    ...
    /// only one element.
    /// </summary>
	public sealed class EnumMono<T> : IEnumerator<T>
	{
        T _val;
        int _pos;
        ...
        /// Constructor
        /// </summary>
        /// <param name="val">Unique object that will be contained into the <see cref="EnumMono{T}"/></param>
        public EnumMono( T val )
        {
            _val = val;
            _pos = -1;
        }
