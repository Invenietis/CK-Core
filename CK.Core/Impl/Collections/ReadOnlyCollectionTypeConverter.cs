#region LGPL License
/*----------------------------------------------------------------------------
* This file (CK.Core\Impl\Collections\ReadOnlyCollectionTypeConverter.cs) is part of CiviKey. 
*  
...
namespace CK.Core
{
    ...
    public class ReadOnlyCollectionTypeConverter<TOuter, TInner> : EnumerableConverter<TOuter, TInner>, IReadOnlyCollection<TOuter>
    {
        ...
        /// </param>
        public ReadOnlyCollectionTypeConverter( ICollection<TInner> c, Converter<TInner, TOuter> innerToOuter, Converter<TOuter, TInner> outerToInner )
            : base( c, innerToOuter )
        {
        ...
        /// <param name="c">Collection to wrap.</param>
        /// <param name="innerToOuter">The converter function from <typeparamref name="TInner"/> to <typeparamref name="TOuter"/>.</param>
        public ReadOnlyCollectionTypeConverter( ICollection<TInner> c, Converter<TInner, TOuter> innerToOuter )
            : base( c, innerToOuter )
        {
        }
