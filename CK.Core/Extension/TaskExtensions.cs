...
namespace CK.Core
{
    ...
    public static class TaskExtensions
    {
        ...
        public static async Task<bool> WaitAsync2( this Task task, int millisecondsTimeout, CancellationToken cancellation = default )
        {
            // Fast path.
            ...
            finally
            {
                ...
                ctsDelay.Dispose();
                if( rCancel.HasValue ) await rCancel.Value.DisposeAsync();
            }
        }
