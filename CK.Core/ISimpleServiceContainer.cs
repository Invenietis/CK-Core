...
namespace CK.Core
{
    ...
    public interface ISimpleServiceContainer : IServiceProvider
    {
        ...
        ISimpleServiceContainer Add( Type serviceType, Func<Object> serviceInstance, Action<Object> onRemove );
        ...
        /// <returns>This object to enable fluent syntax.</returns>
        ISimpleServiceContainer Add( Type serviceType, object serviceInstance, Action<Object> onRemove );
