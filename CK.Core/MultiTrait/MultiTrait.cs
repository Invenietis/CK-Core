...
namespace CK.Core
{
    ...
    public sealed class MultiTrait : IComparable<MultiTrait>
    {
        ...
        readonly ICKReadOnlyList<MultiTrait> _traits;
        ...
        /// </summary>
        internal MultiTrait( MultiTraitContext ctx, string combinedTrait, ICKReadOnlyList<MultiTrait> traits )
        {
        ...
        /// </summary>
        public ICKReadOnlyList<MultiTrait> AtomicTraits
        {
            get { return _traits; }
        }
        ...
        {
            ICKReadOnlyList<MultiTrait> l = left.AtomicTraits;
            int cL = l.Count;
            int iL = 0;
            ICKReadOnlyList<MultiTrait> r = right.AtomicTraits;
            int cR = r.Count;
            int iR = 0;
            for( ; ; )
            {
        ...
        /// This trait does not start the list but the <see cref="MultiTraitContext.EmptyTrait"/> always ends this list.
        /// </summary>
        /// <remarks>
        /// For atomic traits (and the empty trait itself), <see cref="Fallbacks"/> contains only the <see cref="MultiTraitContext.EmptyTrait"/>.
        /// </remarks>
        public IEnumerable<MultiTrait> Fallbacks
        {
            get
            {
        ...
        IEnumerable<MultiTrait> ComputeFallbacks()
        {
            ...
            if( _currentLength > 1 )
            {
                ...
                MultiTrait[] v = new MultiTrait[_currentLength];
                do
                {
                    int i = nbTraits;
            ...
            foreach( MultiTrait m in _traits ) yield return m;
