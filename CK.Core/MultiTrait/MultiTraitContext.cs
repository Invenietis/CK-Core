...
namespace CK.Core
{
    ...
    public sealed class MultiTraitContext
    {
        ...
        readonly IEnumerable<MultiTrait> _enumerableWithEmpty;
        ...
        public MultiTraitContext()
        {
            ...
            _enumerableWithEmpty = new CKReadOnlyListMono<MultiTrait>( _empty );
        ...
        MultiTrait FindOrCreateAtomicTrait( string trait, bool create )
        {
            MultiTrait m;
        ...
        /// </summary>
        internal IEnumerable<MultiTrait> EnumWithEmpty { get { return _enumerableWithEmpty; } }
