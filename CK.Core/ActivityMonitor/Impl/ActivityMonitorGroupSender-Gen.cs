...
namespace CK.Core
{
    ...
    public static partial class ActivityMonitorSendExtension
    {
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, CKTrait tags, string text )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( null, tags, text, DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, CKTrait tags, string format, object arg0 )
        {
            ...
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			if( arg0 is Exception ) throw new ArgumentException( R.PossibleWrongOverloadUseWithException, "arg0" );
			return s.InitializeAndSend( null, tags, String.Format( format, arg0 ), DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, CKTrait tags, string format, object arg0, object arg1 )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( null, tags, String.Format( format, arg0, arg1 ), DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, CKTrait tags, string format, object arg0, object arg1, object arg2 )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( null, tags, String.Format( format, arg0, arg1, arg2 ), DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, CKTrait tags, string format, object arg0, object arg1, object arg2, object arg3 )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( null, tags, String.Format( format, arg0, arg1, arg2, arg3 ), DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, CKTrait tags, string format, params object[] arguments )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( null, tags, String.Format( format, arguments ), DateTime.UtcNow );
        }
        ...
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            return s.IsRejected ? s.Monitor.UnfilteredOpenGroup( s ) : s.InitializeAndSend( null, tags, text(), DateTime.UtcNow );
        }
        ...
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            return s.IsRejected ? s.Monitor.UnfilteredOpenGroup( s ) : s.InitializeAndSend( null, tags, text(param), DateTime.UtcNow );
        }
        ...
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            return s.IsRejected ? s.Monitor.UnfilteredOpenGroup( s ) : s.InitializeAndSend( null, tags, text(param1,param2), DateTime.UtcNow );
        }
        ...
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            return s.IsRejected ? s.Monitor.UnfilteredOpenGroup( s ) : s.InitializeAndSend( null, tags, text(param1,param2,param3), DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, Exception ex, CKTrait tags )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( ex, tags, null, DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, Exception ex, CKTrait tags, string text )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( ex, tags, text, DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, Exception ex, CKTrait tags, string format, object arg0 )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( ex, tags, String.Format( format, arg0 ), DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, Exception ex, CKTrait tags, string format, object arg0, object arg1 )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( ex, tags, String.Format( format, arg0, arg1 ), DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, Exception ex, CKTrait tags, string format, object arg0, object arg1, object arg2 )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( ex, tags, String.Format( format, arg0, arg1, arg2 ), DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, Exception ex, CKTrait tags, string format, object arg0, object arg1, object arg2, object arg3 )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( ex, tags, String.Format( format, arg0, arg1, arg2, arg3 ), DateTime.UtcNow );
        }
        ...
        static public IDisposableGroup Send( this IActivityMonitorGroupSender @this, Exception ex, CKTrait tags, string format, params object[] arguments )
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            if( s.IsRejected ) return s.Monitor.UnfilteredOpenGroup( s );
			return s.InitializeAndSend( ex, tags, String.Format( format, arguments ), DateTime.UtcNow );
        }
        ...
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            return s.IsRejected ? s.Monitor.UnfilteredOpenGroup( s ) : s.InitializeAndSend( ex, tags, text(), DateTime.UtcNow );
        }
        ...
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            return s.IsRejected ? s.Monitor.UnfilteredOpenGroup( s ) : s.InitializeAndSend( ex, tags, text(param), DateTime.UtcNow );
        }
        ...
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            return s.IsRejected ? s.Monitor.UnfilteredOpenGroup( s ) : s.InitializeAndSend( ex, tags, text(param1,param2), DateTime.UtcNow );
        }
        ...
        {
			ActivityMonitorGroupSender s = (ActivityMonitorGroupSender)@this;
            return s.IsRejected ? s.Monitor.UnfilteredOpenGroup( s ) : s.InitializeAndSend( ex, tags, text(param1,param2,param3), DateTime.UtcNow );
        }
