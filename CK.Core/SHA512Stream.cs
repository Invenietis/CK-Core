...
{
    /// <summary>
    /// Simple wrapper around a <see cref="SHA512Managed"/> instance to compute
    /// SHA512 of a stream. Can be used in read or write mode and as a terminal stream
    /// or as a decorator.
    /// </summary>
    public class SHA512Stream : Stream
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="SHA512Stream"/>.
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="SHA512Stream"/> as a decorator on a read or write inner stream.
        /// </summary>
        ...
        public SHA512Stream( Stream inner, bool read, bool leaveOpen )
        {
            _sha512 = new SHA512Managed();
        ...
        /// <summary>
        /// Reads the bytes from the inner (decorated) stream and handles them to update the SHA512
        /// computation state.
        ...
        public override int Read( byte[] buffer, int offset, int count )
        {
            ...
            _sha512.TransformBlock( buffer, offset, r, null, 0 );
            return r;
        }
        ...
        /// <summary>
        /// Writes the given bytes into the inner (decorated) stream and handles them to update the SHA512
        /// computation state.
        ...
        /// <summary>
        /// Asynchronously reads the bytes from the inner (decorated) stream and handles them to update the SHA512
        /// computation state.
        /// This can be called only if this stream is a decorator initialized in read mode.
        /// </summary>
        ...
        public override Task<int> ReadAsync( byte[] buffer, int offset, int count, CancellationToken cancellationToken )
        {
            ...
            return _reader.ReadAsync( buffer, offset, count, cancellationToken )
                          .ContinueWith( x =>
                          {
                              _sha512.TransformBlock( buffer, offset, x.Result, null, 0 );
                              return x.Result;
