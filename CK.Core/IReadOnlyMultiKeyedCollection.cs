#region LGPL License
/*----------------------------------------------------------------------------
* This file (CK.Core\IReadOnlyMultiKeyedCollection.cs) is part of CiviKey. 
*  
...
namespace CK.Core
{
    ...
    public interface IReadOnlyMultiKeyedCollection<out T, in TKey> : IReadOnlyUniqueKeyedCollection<T,TKey>
    {
        /// <summary>
