...
namespace CK.Monitoring.GrandOutputHandlers
{
    ...
    /// </summary>
    public class FileConfigurationBase : HandlerConfiguration
    {
        /// <summary>
        /// Initializes a new <see cref="FileConfigurationBase"/>.
        /// </summary>
        /// <param name="name">Name of this configuration.</param>
        protected FileConfigurationBase( string name )
            : base( name )
        {
        ...
        /// <summary>
        /// Initializes (or reinitializes) this <see cref="FileConfigurationBase"/> from a <see cref="XElement"/>.
        /// </summary>
